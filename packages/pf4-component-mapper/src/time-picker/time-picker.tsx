...
import { BaseFieldProps, TimePickerProps } from '../types';

const TimePicker: React.FC<BaseFieldProps<TimePickerProps>> = (props) => {
  ...
  return (
    ...
    >
      <PF4TimePicker
        {...input}
        onChange={(_e: React.FormEvent<HTMLInputElement>, value: string) => input.onChange(value)}
