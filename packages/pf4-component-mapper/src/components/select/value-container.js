      ...
      if (isMulti && props.children) {
        return (
          <div className="ddorg__pf4-component-mapper__select__value--container">
            { showAll ?
              props.children[0] :
              props.children[0] && props.children[0][0] ? props.children[0][0] : props.children[0] }
            { props.children[0] && props.children[0].length > 1 && (
              ...
              >
                <span>{ showAll ?
                  props.selectProps.showLessLabel :
                  `${props.children[0].length - 1} ${props.selectProps.showMoreLabel}` }</span>
              </Button>
            ) }
