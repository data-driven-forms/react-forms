...
import { WizardToggleProps } from '../../types';

const WizardToggle: React.FC<WizardToggleProps> = ({ activeStepIndex, currentStep, navSchema, isOpen, dispatch }) => {
    ...
    >
      <ol className="pf-v6-c-wizard__toggle-list">
        <li className="pf-v6-c-wizard__toggle-list-item">
          <span className="pf-v6-c-wizard__toggle-num">{index && typeof index === 'number' ? index + 1 : activeStepIndex + 1}</span> {activeStepName}
