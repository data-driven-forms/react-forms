...
import { BaseFieldProps, RadioProps, SelectOption } from '../types';
...
const RadioOption: React.FC<RadioOptionProps> = ({ name, option: { value, label, ...restOption }, isDisabled, isReadOnly }) => {
...
const Radio: React.FC<BaseFieldProps<RadioProps>> = ({ name, type, ...props }) => {
  /**
