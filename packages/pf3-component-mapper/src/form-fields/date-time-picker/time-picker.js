...
const changeHour = (currentHour, increment = true) =>
  increment ? (currentHour + 1 > 23 ? 0 : currentHour + 1) : currentHour - 1 < 0 ? 23 : currentHour - 1;

const changeMinute = (currentMinute, increment = true) =>
  increment ? (currentMinute + 1 > 59 ? 0 : currentMinute + 1) : currentMinute - 1 < 0 ? 59 : currentMinute - 1;

const TimePicker = ({ onHourChange, onMinuteChange, selectedDay }) => (
