...
describe('<TimePicker />', () => {
  ...
  it('should decrement minute to 59 if was 0 before on button click', () => {
    const onMinuteChange = jest.fn();
    const wrapper = mount(<TimePicker {...initialProps} selectedDay={new Date(Date.UTC(2017, 12, 17, 3, 0, 0))} onMinuteChange={onMinuteChange} />);
    wrapper
      .find('.chevron-button')
      .last()
      .simulate('click');
  ...
  it('should increment minute to 0 if was 59 on button click', () => {
    const onMinuteChange = jest.fn();
    const wrapper = mount(<TimePicker {...initialProps} selectedDay={new Date(Date.UTC(2018, 12, 17, 3, 59, 0))} onMinuteChange={onMinuteChange} />);
    wrapper
      .find('.chevron-button')
      .at(1)
      .simulate('click');
  ...
  it('should decrement hours to 23 if was 0 before on button click', () => {
    const onHourChange = jest.fn();
    const wrapper = mount(<TimePicker {...initialProps} selectedDay={new Date('December 17, 2018 00:00:00')} onHourChange={onHourChange} />);
    wrapper
      .find('.chevron-button')
      .at(2)
      .simulate('click');
  ...
  it('should increment hours to 0 if was 23 on button click', () => {
    const onHourChange = jest.fn();
    const wrapper = mount(<TimePicker {...initialProps} selectedDay={new Date('December 17, 2018 23:59:00')} onHourChange={onHourChange} />);
    wrapper
      .find('.chevron-button')
      .first(0)
      .simulate('click');
