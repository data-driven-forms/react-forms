...
const loadOptions = (filter?: string) =>
  new Promise<Array<{ label: string; value: number }>>((res) =>
    setTimeout(() => {
...
const selectSchema: Schema<typeof compositeMapper> = {
  fields: [
    {
...
const App: React.FC = () => {
  const [schema, setSchema] = useState<Schema<typeof compositeMapper>>(wizardSchema as any);
      ...
      <ThemeProvider theme={theme}>
        <LocalizationProvider dateAdapter={AdapterDateFns}>
          <Grid container spacing={4} justifyContent="center" alignItems="center">
            ...
            <Grid item xs={12}>
              <Button onClick={() => setSchema(demoSchema as any)}>Demo schema</Button>
              <Button onClick={() => setSchema(fieldArraySchema)}>Field array</Button>
              <Button onClick={() => setSchema(wizardSchema as any)}>Wizard</Button>
